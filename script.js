const SCRIPT_VERSION = "5.0"; // EXACT provided member list & reset date fix
...
const firebaseConfig = {
  ...
  storageBucket: "red-train-rotation-tool.const SCRIPT_VERSION = "2.5"; // EXACT provided member list (100 members) & reset date fix
...
// --- Initial Theme Render Removed ---firebasestorage.app",
  messagingSenderId: "178389819926",
  appId: "1:178389819926:web:bd59c273641ab8530ccb37"
};
try { firebase.initializeApp(firebaseConfig); } catch (e) { console.error("Firebase Init Error", e); alert("Could not initialize Firebase."); }
